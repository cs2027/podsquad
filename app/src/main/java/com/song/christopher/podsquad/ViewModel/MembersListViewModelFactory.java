...
public class MembersListViewModelFactory implements ViewModelProvider.Factory {
    // Fields holding an 'Application' object & the current group ID number
    private Application application;
    private int groupID;

    // Class constructor
    public MembersListViewModelFactory(Application application, int groupID) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new MembersListViewModel(application, groupID);
    }
}
