...
public class IncompleteTaskViewModelFactory implements ViewModelProvider.Factory {
    // Fields holding an 'Application' object & the current group ID number
    private Application application;
    private int groupID;

    // Class constructor
    public IncompleteTaskViewModelFactory(Application application, int groupID) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new IncompleteTaskViewModel(application, groupID);
    }
}
